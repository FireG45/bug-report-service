package ru.bre.bugreportservice.kafka.config;
...
import ru.bre.bugreportservice.kafka.ReportProducerImpl;
...
public class KafkaConfig {
    ...
    public ReportProducer reportProducer(
        ...
        return new ReportProducerImpl(kafkaTemplate, objectMapper);
    }
